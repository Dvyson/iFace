						...
						while (inputcase2 != 12) {
							...
							switch (inputcase2) {
								...
								case 3:
									...
									for (i = 0; i < users.get(id).newfriends.size(); i++) {
										...
										if (accept == 1) {
											...
											message.setMessagename(users.get(id).newfriends.get(i));
											...
											for (j = 0; j < users.size(); j++) {
												...
												if (users.get(id).newfriends.get(i).equals(users.get(j).name)) {
													...
													message2.setMessagename(users.get(id).name);
								...
								case 6:
									...
									for (i = 0; i < users.size(); i++) {
										if (users.get(i).mycommunity != null && com.equals(users.get(i).mycommunity.getCommunityname())) {
								...
								case 11:
									...
									for (i = 0; i < users.size(); i++) {
										for (j = 0; j < users.get(i).mymessages.size(); j++) {
											if (users.get(id).name.equals(users.get(i).mymessages.get(j).getMessagename())) {
